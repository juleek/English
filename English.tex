...
\begin{ItemizeWithOrigParIndent}
   ...
   \item Нам надо \ex{продержаться} 3 дня. We have to \ex{hold out} for 3 days.
   \item Существует только один \ex{выход}. There is the only \ex{way out}.
   \item В этой, \ex{как и во многих других ситуациях}, сам факт наличия соглашения гораздо важней
   конкретных деталей этого соглашения. In this, \ex{as in many other areas}, the fact that a
   convention exists is more important than the convention's specific details.
   \item Inbox~--- всегда \ex{под рукой}. Inbox is always \ex{there}. Inbox is always \ex{with me}.
\end{ItemizeWithOrigParIndent}
